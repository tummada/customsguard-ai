            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
                ...
                <div className="relative flex flex-col justify-center">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.96 }}
                        className="w-full max-w-[320px] mx-auto flex items-center justify-center gap-3 bg-[#06C755] hover:bg-[#05b34c] text-white font-bold py-3 px-6 rounded-full transition-colors duration-200 disabled:opacity-50 cursor-pointer"
                    >
                        <LineLogo />
                        <span className="text-sm">จองสิทธิ์ด้วย LINE</span>
                    </motion.button>
