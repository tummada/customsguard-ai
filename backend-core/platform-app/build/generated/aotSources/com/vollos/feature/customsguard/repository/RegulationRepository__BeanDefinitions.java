 ...
 */
@Generated
public class RegulationRepository__BeanDefinitions {
  /**
  ...
  public static BeanDefinition getRegulationRepositoryBeanDefinition() {
    ...
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, RegulationRepository.class, RegulationEntity.class, UUID.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.vollos.feature.customsguard.repository.RegulationRepository");
